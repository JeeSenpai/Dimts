...
const case_type_service_1 = require("./case-type.service");
const create_case_type_dto_1 = require("./dto/create-case-type.dto");
const update_case_type_dto_1 = require("./dto/update-case-type.dto");
let CaseTypeController = class CaseTypeController {
    constructor(caseTypeService) {
        this.caseTypeService = caseTypeService;
    }
    create(createCaseTypeDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_case_type_dto_1.CreateCaseTypeDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CaseTypeController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_case_type_dto_1.UpdateCaseTypeDto]),
    __metadata("design:returntype", void 0)
