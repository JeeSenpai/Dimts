...
<!--Sidebar-->
  <aside class=" flex-shrink-0 xs:w-0 sm:w-0 md:w-60 shadow-lg z-50 sidebarColors" aria-label="Sidebar">
   <a :href=" userType + '/dashboard'" class="flex items-center pl-2.5 mt-4" >
      ...
      <span class="self-center text-xl font-semibold text-gray-700">DMITS</span>
   </a>
     ...
     <nav class="font-sans flex relative rounded-b-md flex-row justify-between sm:text-left py-2 px-6 bg-white navBar w-full" aria-label="Navbar">
        ...
        <div class="flex ml-2">
         <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400" type="button"> 
            ...
            <div id="dropdownNotification" class="hidden z-20 w-full rounded-b-md max-w-sm bg-white divide-y divide-gray-100 shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
                  ...
                  <div class="divide-y divide-gray-100 dark:divide-gray-700">
                     <a href="#" class="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <img class="w-11 h-11 rounded-full" src="../assets/Profile.png" alt="Bonnie image">
                     ...
                     <a href="#" class="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div class="flex-shrink-0">
                        <img class="w-11 h-11 rounded-full" src="../assets/Profile.png" alt="Leslie image">
                     ...
                     <a href="#" class="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div class="flex-shrink-0">
                        <img class="w-11 h-11 rounded-full" src="../assets/Profile.png" alt="Robert image">
            ...
            <div class="block py-2 text-sm font-medium text-center rounded-b-lg text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white">
