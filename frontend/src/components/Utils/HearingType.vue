<template>
    <div class="checkFade animated">
        <div class="flex flex-row justify-between">
            ...
            <div>
                <button @click="showAddDialog()" class="mr-3 rounded-xl px-2 mb-2 py-1.5 text-sm border-[1.5px] font-semibold bg-[#BF40BF] border-[#BF40BF] text-white" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdropHearingType">
                ...
                <tbody v-if="displayedPaginatedData.length > 0">
                    <tr v-for="data in displayedPaginatedData" :key="data" class="bg-white border-b text-xs text-center">
                        ...
                        <td class="py-3 px-2 text-right">
                            <button @click="showUpdateDialog(data)" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdropHearingType" class="bg-transparent mr-4 py-1.5">
        ...
        <div>
            <CourtHearingTypesDialog
            ref="CourtHearingTypesDialog"
            v-on:refresh="init()"
            />
        </div>
    </div>
...
import CourtHearingTypesDialog from '../Modals/CourtHearingTypesDialog.vue'
...
export default {
    ...
    methods: {
        ...
        showAddDialog(){
            this.$refs.CourtHearingTypesDialog.initializeAdd()
        },
        showUpdateDialog(data){
            this.$refs.CourtHearingTypesDialog.initializeUpdate(data)
        },
        paginate(data) {
            let page = this.page;
